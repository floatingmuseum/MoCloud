 ...
 */
public class MovieAnticipatedAdapter extends RecyclerView.Adapter<MovieAnticipatedAdapter.AnticipatedViewHolder>{

    private List<BaseMovie> list;
    private Context context;

    public MovieAnticipatedAdapter(List<BaseMovie> list, Context context){
        this.list = list;
