...
public class SPUtil {
    ...
    public static void saveUserLastActivities(LastActivities lastActivities){
        ...
        preferences.edit()
                ...
                .putString("movies_watchlist_at",lastActivities.getMovies().getWatchlisted_at())
                ...
                .putString("episodes_watchlist_at",lastActivities.getEpisodes().getWatchlisted_at())
                ...
                .putString("shows_watchlist_at",lastActivities.getShows().getWatchlisted_at())
                ...
                .putString("seasons_watchlist_at",lastActivities.getSeasons().getWatchlisted_at())
